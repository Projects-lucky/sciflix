 ...
 * TV Shows Page
 * 
 * Server component that renders the TV show discovery page with filtering and infinite scrolling.
 * Pre-fetches initial TV show data and genre options for SEO and performance.
 ...
 * @returns Rendered TV shows page with filters and content
 */
export default async function TVPage({ searchParams }: TVPageProps) {
  ...
  const sort = params.sort || DEFAULT_FILTERS.TV.sort
  ...
  const genres = await genresService.getTVGenres()
  ...
  // Fetch first page of TV show data
  const initialData = await tvService.getDiscover({ ...filters, page: 1 })
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full">
        ...
        <section className="tv-page flex-1 container mx-auto px-4 py-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-3xl font-bold font-sans text-red-primary">TV Shows</h1>
          </div>
